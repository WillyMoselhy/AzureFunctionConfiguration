...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\AzureFunctionConfiguration\functions", "$global:testroot\..\AzureFunctionConfiguration\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\AzureFunctionConfiguration\functions"
    "$global:testroot\..\AzureFunctionConfiguration\internal\functions"
)
